...
`V1-001` through `V1-014` cover dependencies, Drift, profile domain and persistence, preferences, Riverpod state, UI integration, history, deletion, UX refinement, persistence tests, and full-flow tests.
